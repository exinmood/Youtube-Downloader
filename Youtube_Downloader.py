...
bn1 = Button(window , text='Open' , fg='gray')
bn2 = Button(window , text='Download', bg='green' , font=100 , height=2, width=9)

lb1.grid(padx=10, pady=8 , sticky='w')
...
bn2.grid(row=2, column=1 , pady=0 , )
